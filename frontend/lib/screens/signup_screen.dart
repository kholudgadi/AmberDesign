                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            widget.isDesigner ? 'إنشاء حساب مصمم' : 'إنشاء حساب مستخدم',
                          ...
                          ElevatedButton(
                            ...
                            onPressed: _isFormValid 
                              ? () {
                                  debugPrint("تم الضغط على التالي وكل الحقول معبأة!");
                                } 
                              : null,
                            style: ElevatedButton.styleFrom(
                              ...
                              elevation: _isFormValid ? 8 : 0, // Elevation is set to 0 when the button is disabled to give a flat appearance
                            ),
                            child: const Text(
                              'التالي',
                              style: TextStyle(
